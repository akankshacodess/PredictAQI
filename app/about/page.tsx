  ...
  return (
    <div className="px-4">
      ...
      <div className="min-h-screen">
        ...
        <div className={clsx("flex flex-col md:flex-row items-center", "bg-background shadow-lg p-6 rounded-lg min-h-svh", "hover:shadow-xl transition-shadow")}>
          ...
          <div className="w-full md:w-1/2 p-4">
            <h2 className="font-bold text-2xl mb-4 text-primary">Introduction</h2>
        ...
        {/* Problem Section */}
        <div className={clsx("flex flex-col md:flex-row-reverse items-center", "bg-background shadow-lg p-6 rounded-lg min-h-svh", "hover:shadow-xl transition-shadow")}>
          <div className="w-full md:w-1/2 p-4">
            <Image
          ...
          <div className="w-full md:w-1/2 p-4">
            <h2 className="font-bold text-2xl mb-4 text-primary">Problem We Faced</h2>
            <p className="text-secondary">
